const SignUpModal = () =>{
  return (
    <div className="flex flex-col p-6 bg-white drop-shadow-md rounded-2xl m-auto">
      ...
      <button className="bg-green-bnk-200 text-white rounded-2xl outline-none drop-shadow-md duration-200 h-12 w-64 my-4 hover:bg-green-600">Sign Up</button>
      <p className="flex justify-center font-bold text-sm mt-8">Aready have an account?<a className="text-green-bnk-200 ml-1 hover:text-green-600 cursor-pointer"> Login</a></p>
    </div>
  )
}
